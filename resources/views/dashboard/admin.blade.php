    ...
    <div class="card-group">
        ...
        <div class="card border-right">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{ $buyer_count }}</h2>
                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pembeli Terdaftar</h6>
                    </div>
                    <div class="ml-auto mt-md-3 mt-lg-0">
        ...
        <div class="card border-right">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <div class="d-inline-flex align-items-center">
                            <h2 class="text-dark mb-1 font-weight-medium">{{ $seller_count }}</h2>
                        </div>
                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Penjual Terdaftar</h6>
                    </div>
                    <div class="ml-auto mt-md-3 mt-lg-0">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    ...
                    <div class="ml-auto mt-md-3 mt-lg-0">
                        <span class="opacity-7 text-muted"><i class="fas fa-credit-card"></i></span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table no-wrap v-middle mb-0">
                            <thead>
                                <tr class="border-0">
                                    ...
                                    <th class="border-0 font-14 font-weight-medium text-muted">Total Terjual</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table no-wrap v-middle mb-0">
                            <thead>
                                <tr class="border-0">
                                    <th class="border-0 font-14 font-weight-medium text-muted">Nama Pembeli</th>
                                    <th class="border-0 font-14 font-weight-medium text-muted">Tanggal Transaksi</th>
                                    <th class="border-0 font-14 font-weight-medium text-muted">Total Transaksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($last_transactions as $item)
                                    <tr>
                                        <td class="border-top-0 px-2 py-4">
                                            <div class="d-flex no-block align-items-center">
                                                <div class="">
                                                    <h5 class="text-dark mb-0 font-16 font-weight-medium">{{ $item->buyer->name }}</h5>
                                                    <span class="text-muted font-14">{{ $item->buyer->userDetail->phone_number }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="border-top-0 text-muted text-center px-2 py-4 font-14">{{ $item->created_at->format('d M Y') }}</td>
